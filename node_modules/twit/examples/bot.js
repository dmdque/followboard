...
Bot.prototype.prune = function (callback) {
  ...
  if(unfollowQueue.length != 0){
    self.twit.post('friendships/destroy', { id: unfollowQueue.pop()}, callback);   
    console.log("number of api calls:" + 1);
    //console.log(unfollowQueue);
  } else{
            ...
            for(var i = 0; i < 20; i++){
              ...
              if(!~followers.indexOf(target)) {
                if(i >= 20){
                  ...
                  console.log("number of api calls:" + 3);
                } else{
                  unfollowQueue.push(target);
                }
              }
            }
        });
